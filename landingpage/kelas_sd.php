...
<body>
    <div class="container">
        ...
        <div class="buttons-group kelas-buttons">
            <div class="button">Kelas 1</div>
            <div class="button">Kelas 2</div>
            <div class="button">Kelas 3</div>
            <div class="button">Kelas 4</div>
            <div class="button">Kelas 5</div>
            <div class="button">Kelas 6</div>
            
        </div>
          <a href="http://localhost/bimbel/landingpage/pembayaran1.php" class="save-button">Simpan</a>
    </div>
    <script>
